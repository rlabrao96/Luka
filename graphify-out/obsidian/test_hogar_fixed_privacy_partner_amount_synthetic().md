...
# test_hogar_fixed_privacy_partner_amount_synthetic()

## Connections
- [[Privacy invariant even when we SEED partner real income, household view     mus]] - `rationale_for` [EXTRACTED]
- [[Transaction]] - `calls` [INFERRED]
- [[_assert_value_absent()]] - `calls` [EXTRACTED]
