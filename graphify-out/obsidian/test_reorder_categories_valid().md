...
# test_reorder_categories_valid()

## Connections
- [[Valid reorder updates sort_order on existing rows.]] - `rationale_for` [EXTRACTED]
- [[_execute_returning()]] - `calls` [EXTRACTED]
- [[_make_pref()]] - `calls` [EXTRACTED]
- [[_mock_db()]] - `calls` [EXTRACTED]
- [[reorder_categories()]] - `calls` [INFERRED]
