---
source_file: "backend/modules/auth/models.py"
type: "code"
...
- [[BudgetSettingsRequest]] - `uses` [INFERRED]
- [[BudgetSettingsResponse]] - `uses` [INFERRED]
...
- [[Debug script Fetch raw Banco de Chile emails and print their exact bodies. Run]] - `uses` [INFERRED]
- [[Debug Strip HTML and show the text content the parser actually sees.]] - `uses` [INFERRED]
- [[Decode a Supabase JWT using JWKS (supports ES256, RS256, HS256).      Tries JWKS]] - `uses` [INFERRED]
...
- [[Extract text body from Gmail message payload.]] - `uses` [INFERRED]
...
- [[GET  PATCH settingsbudget — savings target + payday day-of-month.  Thin layer]] - `uses` [INFERRED]
...
- [[One-off script Scan last 2 months of Gmail and test the email pre-filter. Run f]] - `uses` [INFERRED]
...
- [[Recursively extract all text body parts.]] - `uses` [INFERRED]
...
- [[Response must NOT include 'hidden' field.]] - `uses` [INFERRED]
...
- [[Scan for Banco de Chile TC payment and transfer emails specifically.]] - `uses` [INFERRED]
- [[Scan last 2 months of Gmail and show only successfully parsed bank transactions.]] - `uses` [INFERRED]
...
- [[Strip HTML tags and collapse whitespace to see what regex sees.]] - `uses` [INFERRED]
...
- [[Validate Supabase JWT and return the User.      Uses JWKS for local validation (]] - `uses` [INFERRED]
...
- [[_get_or_create_user()]] - `calls` [INFERRED]
...
- [[mock_partner()]] - `calls` [INFERRED]
- [[mock_user()]] - `calls` [INFERRED]
- [[mock_user()_1]] - `calls` [INFERRED]
- [[mock_user()_2]] - `calls` [INFERRED]
- [[mock_user()_3]] - `calls` [INFERRED]
- [[mock_user_for_pin()]] - `calls` [INFERRED]
